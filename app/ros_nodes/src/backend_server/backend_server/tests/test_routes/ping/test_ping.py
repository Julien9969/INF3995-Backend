...
# @patch("backend_server.api.ping.routes_ping.PingBase.ping")
# def test_get_ping(ping_mock, client):
#     ping_mock.return_value = "pong"
...
# @patch("backend_server.api.ping.routes_ping.PingBase.ping")
# @patch("backend_server.api.ping.routes_ping.PingBase.send_cmd_vel")
