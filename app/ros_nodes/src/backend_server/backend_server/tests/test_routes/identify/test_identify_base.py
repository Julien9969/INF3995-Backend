...
async def test_launch_client(mock_identify_client, shutdown_mock, init_mock):
...
async def test_launch_client_failure(mock_identify_client, shutdown_mock, init_mock, mock_hasattr): 
